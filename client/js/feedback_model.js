...
export function describeWinReason(reason) {
  const keys = {
    ...
    6: "win.convoy_delivered", 7: "win.convoy_stopped", 8: "win.heist_timeout",
  };
...
export function describeEvent(e, myTeam) {
  switch (e?.type) {
    ...
    case "station_eject_warning": return t("ev.station_eject_warning");
    case "station_ejected": return t("ev.station_ejected", { id: e.operatorId });
    case "prison_raided":
      return t(e.team === myTeam ? "ev.prison_raided_them" : "ev.prison_raided_us", { n: e.freed });
    case "operator_captured":
      return t(e.team === myTeam ? "ev.operator_captured_us" : "ev.operator_captured_them",
        { id: e.operatorId });
    case "pow_delivered":
