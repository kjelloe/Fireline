...
export const UNIT_STATS = Object.freeze({
  [UNIT_TANK]: Object.freeze({
    ...
    speed: 16, range: 1280, minRange: 0, hp: 100, damage: 20, indirect: false,
  }),
  [UNIT_SCOUT]: Object.freeze({
    id: UNIT_SCOUT, name: "scout",
    speed: 28, range: 1024, minRange: 0, hp: 60, damage: 10, indirect: false,
  }),
  [UNIT_ARTILLERY]: Object.freeze({
    id: UNIT_ARTILLERY, name: "artillery",
    speed: 8, range: 3072, minRange: 768, hp: 80, damage: 30, indirect: true,
  }),
});
