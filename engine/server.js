...
export class GameServer {
  constructor(options = {}) {
    ...
    this.ai = options.enableAi === true
      ...
      ? new AIRegency({ difficulty: this.aiDifficulty, mirrored: options.aiMirrored === true, uniqueCrewing: options.uniqueCrewing !== false, raidParty: options.raidParty !== false })
      : null;
