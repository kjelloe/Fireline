...
export const MAP_LAYOUTS = Object.freeze({
  ...
  sawtooth: Object.freeze({
    ...
    relayCells: [
      ...
      // Q64 CACHE PAIR PULLED same day (battery verdict: 65.5/70.2%
      // A — the aura SNOWBALLS whoever already holds the lanes, and
      // sawtooth already leans; held 55-56 became 68). The mechanism
      // stays engine-complete + sandbox-tested (test/cache.test.js,
      // CACHE=0 switch) awaiting a fairer home — the vault's exact
      // arc, now the specials ladder's second lesson: PERSONALITY
      // NODES AMPLIFY THE MAP'S EXISTING LEAN.
    ],
    standardHomes: [{ cellX: 14, cellY: 59 }, { cellX: 113, cellY: 59 }],
  }),
});
