...
| **Q71** | **THE Q18 GO**: the team-keyed remainder (convoy 39/64, POWS=2 at 25-28% A post-terrain-fix — out of band for the human flavour) points at execution-order first-strike; the tick-parity command-order fix has been proposed since night 2 AWAITING GO. Trial it behind a kill-switch and measure the convoy+POWS pairs? | **you** | — |
