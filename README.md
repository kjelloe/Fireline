...
[MIT](LICENSE). All runtime dependencies (express, ws, three.js) are MIT;
all art and audio in this repository is generated by the repository's own
tools. *Firepower* (1987) is an inspiration only — this is a new IP with
no assets or code from the original.
